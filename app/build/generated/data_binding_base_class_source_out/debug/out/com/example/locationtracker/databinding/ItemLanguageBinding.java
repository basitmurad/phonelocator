...
public final class ItemLanguageBinding implements ViewBinding {
  ...
  private ItemLanguageBinding(@NonNull LinearLayout rootView, @NonNull TextView languageName) {
  ...
  public static ItemLanguageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLanguageBinding((LinearLayout) rootView, languageName);
    }
